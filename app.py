...
def render_content(tab):
    ...
    if tab == 'tab_1_graph':
        ...
        for _libelle, _localisation, _coordinates, _debut, _fin in zip(complete_df['libelle_split'], complete_df['localisation_split'], complete_df['geolocalisation'], complete_df['fields.date_debut'].dt.strftime('%d/%m'), complete_df['fields.date_fin'].dt.strftime('%d/%m')):
